...
angular.module('volunteersRUs', ['ionic', 'ngCordova', 'volunteersRUs.controllers','volunteersRUs.services','lbServices'])
...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app.aboutus', {
   ...
   .state('app.favorites', {
    ...
    .state('app.volunteerevent', {
      ...
      views: {
        'mainContent': {
          templateUrl: 'templates/volunteerevent.html',
  ...
  .state('app.volunteereventdetail', {
    ...
    views: {
      'mainContent': {
        templateUrl: 'templates/volunteereventdetail.html',
